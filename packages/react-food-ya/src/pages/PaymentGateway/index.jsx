      ...
      case 1:
        return (
          <div>
            ...
            <button type="button" onClick={() => { setPage(0); }}>Page1</button>
            <button type="button" onClick={() => { setPage(2); }}>Page3</button>
          </div>
        );
      case 2:
        return (
          <div>
            ...
            <button type="button" onClick={() => { setPage(1); }}>Page2</button>
          </div>
        );
      case 0:
      default:
