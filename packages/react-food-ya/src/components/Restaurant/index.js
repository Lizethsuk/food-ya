        ...
        return (
            <div className='restaurant-section'>
                <div className='infoRestaurant'>
                    ...
                    <img src={restaurantDescription.img.url} />
                    <ul className='ulDescription'>
                        <li><VscVerified/>{restaurantDescription.type}</li>
                        <li><VscHistory/>{restaurantDescription.schedule}</li>
                        <li><VscStarFull/>{restaurantDescription.points}</li>
                    </ul>
                </div>
