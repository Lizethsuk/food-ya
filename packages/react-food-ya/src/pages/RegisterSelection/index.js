    ...
    <div className="register-selection-page">
      ...
      <div className="register-container">
        ...
        <div className="register-option-container">
          <RegisterOption
            img_content={
              "https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/f37288f1ff264310c703ea536190f79c.svg "
            }
          ...
          <RegisterOption
            img_content={
              "https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/d68c5f5ddd33d16a8d6855987410673b.svg"
            }
        ...
        <Button content="Sign In" buttonStyle={"fit-content-button margin"} url={"/sign-in"} />
      </div>
    </div>
  );
};
